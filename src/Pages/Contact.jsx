...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const formSubmitUrl = 'https://formsubmit.co/muhammadbaguserlangga@gmail.com';
    ...
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] " >
      ...
      >
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[45%_55%] 2xl:grid-cols-[35%_65%] gap-12" >
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  className="w-full p-4 pl-12 bg-white/10 rounded-xl border border-white/20 placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-[#0ea5e9]/30 transition-all duration-300 hover:border-[#0ea5e9]/30 disabled:opacity-50"
                  required
                />
              </div>
              <div
              ...
              >
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  disabled={isSubmitting}
                  className="w-full resize-none p-4 pl-12 bg-white/10 rounded-xl border border-white/20 placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-[#0ea5e9]/30 transition-all duration-300 hover:border-[#0ea5e9]/30 h-[9.9rem] disabled:opacity-50"
                  required
                />
              </div>
              <button
          ...
          <div className="  bg-white/5 backdrop-blur-xl rounded-3xl p-3 py-3 md:p-10 md:py-8 shadow-2xl transform transition-all duration-500 hover:shadow-[#0ea5e9]/10">
            <Komentar />
          </div>
        </div>
      </div>
