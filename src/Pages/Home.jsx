...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/BagusErlangga", label: "GitHub Profile" },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Website resmi Muhammad Bagus Erlangga, Full Stack Developer. Saya berfokus pada penciptaan pengalaman digital yang menarik dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan." />
     ...
     <meta property="og:description" content="Website resmi dan portofolio Muhammad Bagus Erlangga, Full Stack Developer." />
        ...
        <script type="application/ld+json">{`
          {
            ...
            "url": "https://ekizr.com",
            "sameAs": [
              "https://github.com/BagusErlangga",
