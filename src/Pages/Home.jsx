  ...
  <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-5xl sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl font-bold tracking-tight">
      <span className="relative inline-block">
        ...
        <span className="relative bg-gradient-to-r from-white via-blue-100 to-sky-200 bg-clip-text text-transparent">
          Full Stack
        </span>
      </span>
      <br />
...
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind", "Laravel", "MySQL", "Supabase"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/BagusErlanggaa", label: "GitHub Profile" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/bagus-erlangga/", label: "LinkedIn Profile" },
  { icon: Instagram, link: "https://www.instagram.com/lanzzz.20/?hl=id", label: "Instagram Profile" }
];
        ...
        <script type="application/ld+json">{`
          {
            ...
            "sameAs": [
              ...
              "https://www.instagram.com/lanzzz.20/"
            ]
          }
        `}</script>
      </Helmet>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
              ...
              <div className="w-full py-0 md:py-[10%] sm:py-0 lg:w-1/2 h-[260px] sm:h-[400px] lg:h-[600px] xl:h-[750px] relative flex items-center justify-center order-2 lg:order-2  mt-5 sm:mt-0"
                ...
                <div className="relative w-full opacity-90">
                  <div className={`absolute inset-0 bg-gradient-to-r from-[#0ea5e9]/10 to-[#06b6d4]/10 rounded-3xl blur-3xl transition-all duration-700 ease-in-out ${
                  ...
                  <div className={`absolute inset-0 pointer-events-none transition-all duration-700 ${
                    ...
                    <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-gradient-to-br from-sky-500/10 to-cyan-500/10 blur-3xl animate-[pulse_6s_cubic-bezier(0.4,0,0.6,1)_infinite] transition-all duration-700 ${
