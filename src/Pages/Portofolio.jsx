...
const techStacks = [
  ...
  { icon: "https://raw.githubusercontent.com/devicons/devicon/master/icons/supabase/supabase-original.svg", language: "Supabase" },
];
    ...
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#0ea5e9] to-[#06b6d4]">
          <span style={{
            color: '#0ea5e9',
            backgroundImage: 'linear-gradient(45deg, #0ea5e9 10%, #06b6d4 93%)',
