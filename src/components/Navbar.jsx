                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex-shrink-0">
                        <a
                            ...
                            className="text-xl font-bold bg-gradient-to-r from-[#06b6d4] to-[#0ea5e9] bg-clip-text text-transparent"
                        >
                            Bagus
                        </a>
                    </div>
                    ...
                    <div className="md:hidden">
                        <button
                            ...
                            className={`relative p-2 text-sky-200 hover:text-white transition-transform duration-300 ease-in-out transform ${
