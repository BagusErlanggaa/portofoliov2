  ...
  return (
    <li className="group flex items-start space-x-3 p-2.5 md:p-3.5 rounded-xl hover:bg-white/5 transition-all duration-300 border border-transparent hover:border-white/10">
      <div className="relative mt-2">
        ...
        <div className="relative w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-gradient-to-r from-blue-400 to-sky-400 group-hover:scale-125 transition-transform duration-300" />
      </div>
...
const ProjectDetails = () => {
  ...
  const projectUrl = `https://baguserlangga.dev/project/${toSlug(project.title)}`;

  return (
    <>
      <Helmet>
        <title>{project.title} — Muhammad Bagus Erlangga</title>
        <meta
          name="description"
          content={
            project.description
              ? project.description.slice(0, 155)
              : `Project ${project.title} oleh Muhammad Bagus Erlangga — Full Stack Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.title} — Muhammad Bagus Erlangga`}
        />
        <meta
      ...
      <div className="min-h-screen bg-[#030014] px-[2%] sm:px-0 relative overflow-hidden">
        <div className="fixed inset-0">
          <div className="absolute -inset-[10px] opacity-20">
            <div className="absolute top-0 -left-4 w-72 md:w-96 h-72 md:h-96 bg-sky-400 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob" />
            ...
            <div className="grid lg:grid-cols-2 gap-8 md:gap-16">
              <div className="space-y-6 md:space-y-10 animate-slideInLeft">
                <div className="space-y-4 md:space-y-6">
                  <h1 className="text-3xl md:text-6xl font-bold bg-gradient-to-r from-blue-200 via-sky-200 to-cyan-200 bg-clip-text text-transparent leading-tight">
                    {project.title}
                  </h1>
                  <div className="relative h-1 w-16 md:w-24">
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-sky-500 rounded-full animate-pulse" />
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-sky-500 rounded-full blur-sm" />
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-3 md:gap-4">
                  <a
                    ...
                    className="group relative inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 bg-gradient-to-r from-blue-600/10 to-sky-600/10 hover:from-blue-600/20 hover:to-sky-600/20 text-blue-300 rounded-xl transition-all duration-300 border border-blue-500/20 hover:border-blue-500/40 backdrop-blur-xl overflow-hidden text-sm md:text-base"
                  >
                    <div className="absolute inset-0 translate-y-[100%] bg-gradient-to-r from-blue-600/10 to-sky-600/10 transition-transform duration-300 group-hover:translate-y-[0%]" />
